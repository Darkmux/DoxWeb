...
█═════════════════════════════════════════════════════════█
█ [${blanco}5${verde}] ${blanco}Ruc        ${verde}┃ [${blanco}14${verde}] ${blanco}EstadoDoc    ${verde}┃ [${blanco}23${verde}] ${blanco}StalkScan     ${verde}█
█═════════════════════════════════════════════════════════█
█ [${blanco}6${verde}] ${blanco}Tinfoleak  ${verde}┃ [${blanco}15${verde}] ${blanco}BuscarDatos  ${verde}┃ [${blanco}24${verde}] ${blanco}Colegiados    ${verde}█
█═════════════════════════════════════════════════════════█
█ [${blanco}7${verde}] ${blanco}Sis        ${verde}┃ [${blanco}16${verde}] ${blanco}Certificados ${verde}┃ [${blanco}25${verde}] ${blanco}Dirección     ${verde}█
█═════════════════════════════════════════════════════════█
█ [${blanco}8${verde}] ${blanco}NumVerify  ${verde}┃ [${blanco}17${verde}] ${blanco}Licencia     ${verde}┃ [${blanco}26${verde}] ${blanco}SkypeIp       ${verde}█
█═════════════════════════════════════════════════════════█
...
case $Opcion_DoxWeb in
	...
	6)
		...
		;;
	7)
		termux-open http://app.sis.gob.pe/SisConsultaEnLinea/Consulta/frmConsultaEnLinea.aspx
		;;
	8)
	...
	14)
		...
		;;
	15)
		termux-open http://buscardatos.com/
		;;
	16)
		termux-open http://certificados.sena.edu.co/
		;;
	17)
		termux-open http://web.mintransporte.gov.co/Consultas/transito/Consulta23122010.htm
		;;
	18)
	...
	22)
		...
		;;
	23)
		termux-open https://stalkscan.com/
		;;
	24)
		termux-open http://www.cipica.com/buscolegiado/buscolegiado.php
		;;
	25)
		termux-open http://www.midis.gob.pe/padron/
		;;
	26)
